...
public class AdesaoResponseMapTests
{
    ...
    public void MapearParaResponse_ComDadosValidos_DeveMapearCorretamente()
    {
        ...
        result.DataAdesao.Should().Be(cliente.DataAdesao);
        ...
        result.ContaGrafica.DataCriacao.Should().Be(contaGrafica.DataCriacao);
    }
    ...
    public void MapearParaResponse_FormatoData_DeveSerPadraoIso()
    {
        ...
        // Assert
        result.DataAdesao.Should().BeCloseTo(DateTime.UtcNow, TimeSpan.FromMinutes(1));
        result.ContaGrafica.DataCriacao.Should().BeCloseTo(DateTime.UtcNow, TimeSpan.FromMinutes(1));
    }

...
namespace CompraProgramadaAcoes.Application.Workers;

public class CompraProgramadaWorker : BackgroundService
{
    private readonly ILogger<CompraProgramadaWorker> _logger;
    private readonly IServiceProvider _serviceProvider;
    private readonly TimeSpan _intervaloExecucao = TimeSpan.FromHours(1); // Verifica a cada hora

    public CompraProgramadaWorker(

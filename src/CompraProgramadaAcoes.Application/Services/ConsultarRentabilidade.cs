...
public class ConsultarRentabilidade(
      ...
      string pastaCotacoes = "cotacoes") : IConsultarRentabilidade
{
  ...
  private readonly ILogger<ConsultarRentabilidade> _logger = logger;
